...
<head>
    ...
    <script>
        var Truq = angular.module('Truq', ['ui.router']);
        // For Component users, it should look like this:
        // var Truq = angular.module('Truq', [require('angular-ui-router')]);
    </script>
    ...
</head>
<body>
...
>
```javascript
Truq.config(function($stateProvider, $urlRouterProvider) {
  //
...
>
```javascript
Truq.config(function($stateProvider) {
  $stateProvider
    .state('index', {
      url: "",
      views: {
